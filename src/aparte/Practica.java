...
public class Practica {
    ...
    public static void sumandoDif(LinkedList<Integer>l, int n, int i){
        int sum = suma(l);
        if (sum>n) {
            return;
        }
    ...
    public static void resolverMochila(LinkedList<mochila>o,LinkedList<mochila>m, int max, int i){
        int sum = suma2(m);
        if (sum>max) {
            return;
        }
    ...
    public static void permutSr(LinkedList<String>l1,LinkedList<String>l2, int r, int i){
        if (l2.size() == r) {
            System.out.println(l2);
            return;
        }
    ...
    public static void mostrarPositivos(LinkedList<Matriz2>l){
        for (Matriz2 m : l) {
            if (esPostivo(m)) {
                m.mostrar();
            }
